...
const translations = {
  en: {
    ...
    f1desc: "Fast checkout with Cash, Mobile-Money, Card, and Credit payment methods. Barcode scanning included.",
    f2title: "Inventory",
  ...
  sw: {
    ...
    f1desc: "Malipo ya haraka kwa Pesa Taslimu, Mobile-Money, Kadi, na Deni. Uchanganuzi wa barcode umewekwa.",
